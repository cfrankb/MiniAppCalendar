...
/// @param text
/// @return coloring rules which apply to this text
...
/// @brief Color a calendar text box. This applys coloring rules for
///        text content as well as for past and current days.
/// @param day_count target dat
/// @param text text of the box
/// @return coloring rule css to apply
...
/// @brief Color the modified textbox by applying the rules.
...
/// @brief Return name of a given month
...
/// @brief Compute the number of days in a given month
/// @param year
/// @param month
...
/// @brief Final event when the mainwindow is closed
/// @param event
...
/// @brief Adjust size of the controls when the window is resized
/// @param event
...
/// @brief Update calendar based on current month
...
/// @brief Reloading settings when application starts
...
/// @brief Change the current month
